...
@Composable
fun HomeComponent(
    groupedCharacters: Map<String, List<DemonSlayerCharacter>>,
    query: String,
        ...
        LazyColumn(
            ...
            stickyHeader {
                Row(
                    ...
                    AppBarMenu(navigateToAbout = navigateToAbout, navigateToFavorite = navigateToFavorite)
                }
            }

            groupedCharacters.forEach{(_, characters) ->
